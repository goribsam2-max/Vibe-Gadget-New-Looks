    ...
    return (
        <div className="flex flex-col items-center justify-center text-center py-40 animate-fade-in bg-zinc-50 dark:bg-[#000000] min-h-screen">
          ...
          <button
            ...
            className="px-8 py-4 bg-zinc-800 dark:bg-zinc-200 text-white rounded-[15px] font-semibold text-sm hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center space-x-3"
          >
            <span>Sign In</span>
        ...
        <div className="py-2">
          ...
          <SectionColumns
            ...
            description={<>
              ...
              <div className="mt-2">
                <StatusBadge leftIcon={isAdmin ? ShieldCheck : UserSquare2} leftLabel={isAdmin ? "Admin" : "Member"} />
              </div>
            </>}
          >
          ...
          {localUserData?.isAffiliate && (
            <>
              ...
              >
                  <div className="bg-zinc-800 dark:bg-zinc-200 border border-zinc-900 dark:border-zinc-100 rounded-[15px] p-6 text-white relative overflow-hidden group">
                    ...
                    <Button
                      ...
                      className="w-full bg-white text-emerald-900 hover:bg-zinc-100 dark:bg-zinc-800 font-bold"
                    >
                      Manage Affiliate
                    </Button>
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              >
                <div className="flex items-center space-x-4">
                  <div className="w-10 h-10 rounded-[15px] bg-zinc-100 dark:bg-zinc-800 dark:bg-emerald-900/20 flex items-center justify-center border border-emerald-100 dark:border-emerald-800/50 text-zinc-800 dark:text-zinc-200 dark:text-zinc-700 dark:text-zinc-300">
